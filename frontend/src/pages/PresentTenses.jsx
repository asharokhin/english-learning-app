              ...
              <article className={styles.formatted}>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        has stopped to talk to Lisa – but she plans to continue
                        looking round later.)
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>
                        with a word like <em>always</em> or <em>continually</em>{" "}
                        if we want to criticise or complain:
                      </p>
                      <p>
                        <span className={styles.example}>
                          {" "}
                ...
                <section ref={s4}>
                  ...
                  <p>
                    ...
                    emphasises that a situation is temporary. It often describes
