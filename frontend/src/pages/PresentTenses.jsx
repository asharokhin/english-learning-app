            ...
            <div className={styles.content}>
              <article className={styles.formatted}>
                  ...
                  <div className="section-content">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <p className={styles.example}>
                          The story <strong>begins</strong> and{" "}
                          <strong>ends</strong> in Spain. The year{" "}
                          <strong>is</strong> 1937.
                        </p>
                      </li>
                    </ul>
                    <br />
                  ...
                  <div className="section-content">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <p className={styles.example}>
                              He
                              <strong>&apos;s working</strong> in London this
                              week.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <p className={styles.example}>
                              {" "}
                              I<strong>&apos;m not working</strong> in London
                              this week.
                            </p>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <p className={styles.example}>
                              <strong>Are</strong> you <strong>working</strong>{" "}
                              in London this week?
                            </p>
                          </td>
                        </tr>
                    ...
                    <ul>
                      <li>
                        ...
                        <p className={styles.example}>
                          I<strong>&apos;m looking</strong> at a blue bag right
                          now.
                        </p>
                      </li>
                      <li>
                        <p>
                          to suggest that an action is temporary, often with
                          words like now, at the moment, at present or just:
                        </p>
                        <p className={styles.example}>
                          They
                        ...
                        <p>
                          <span className={styles.example}>
                            I<strong>&apos;m working</strong> in London this
                            week.
                          </span>{" "}
                      ...
                      <li>
                        <p>
                          for an action around the time of speaking, which has
                          begun but is not finished:
                        </p>
                        <p className={styles.example}>
                        ...
                        <p>
                          <span className={styles.example}>
                            I<strong>&apos;m looking</strong> round the
                            shops.&nbsp;
                          </span>
                          (Millie isn&apos;t looking round at this moment – she
                          has stopped to talk to Lisa – but she plans to
                      ...
                      <li>
                        ...
                        <p className={styles.example}>
                          ...
                          <strong>is rising</strong>.
                        </p>
                      </li>
                      <li>
                        <p>
                          with a word like <em>always</em> or{" "}
                          <em>continually</em> if we want to criticise or
                          complain:
                        </p>
                        <p>
                          <span className={styles.example}>
                        ...
                        <p className={styles.example}>
                          He
                          <strong>&apos;s always complaining</strong> about
                          things.
                        </p>
                      </li>
                      <li>
                        ...
                        <p className={styles.example}>
                          I<strong>&apos;m always meeting</strong> my neighbour
                          John near the station. I guess he works somewhere near
                          there.
                        </p>
                      </li>
                    </ul>
                ...
                <section id={2}>
                  ...
                  <div className="section-content">
                    <p>
                      These verbs are nearly always used in a simple rather than
                      a continuous tense. They are mostly about thoughts,
                    ...
                    <ul>
                      ...
                      <li>
                        <p>
                          feelings:{" "}
                          <em>
                            adore, dislike, despise, hate, like, love, want,
                            wish, prefer
                          </em>
                          :
                        </p>
                        <p className={styles.example}>
                          They <strong>despise</strong> me because of the way
                          I&apos;m living.
                        </p>
                      </li>
                      <li>
                        ...
                        <p className={styles.example}>
                          The manager <strong>has</strong> the biggest company
                          car.
                        </p>
                      </li>
                      <li>
                        ...
                        <p className={styles.example}>
                          I <strong>hear</strong> what you&apos;re saying to me,
                          but I don&apos;t agree.
                        </p>
                        <p className={styles.example}>
                          <strong>Do</strong> you <strong>see</strong> anything
                          you want to buy here?
                        </p>
                        <p>
                          We use <em>can</em> with these verbs to show we are
                      ...
                      <li>
                        <p>
                          other state verbs:{" "}
                          <em>need, contain, deserve, fit, seem, look</em> (=
                    ...
                    <p>
                      <em>Have</em> can be continuous when it does not mean
                      `possess`:
                    </p>
                    <p className={styles.example}>
                      Steve <strong>is having</strong> a difficult time at
                      college this term.
                    </p>
                    <p className={styles.example}>
                    ...
                    <p>
                      <em>Taste</em> and <em>smell</em> can be continuous when
                      they refer to what someone is doing:
                    </p>
                    <p className={styles.example}>
                      I<strong>&apos;m tasting</strong> the sauce.
                    </p>
                    <p>
                      <em>Listen to, watch</em> and <em>look</em> at are not
                    ...
                    <p className={styles.example}>
                      ...
                      <strong>&apos;s seeing</strong> a doctor about her sore
                      throat.
                    </p>
                    <p>
                      <em>Weight</em> can be continuous when it refers to what
                      someone is doing:
                    </p>
                    <p className={styles.example}>
                      The shop assistant <strong>is weighing</strong> the
                      cheese.
                    </p>
                  </div>
                </section>
                <section id={3}>
                  ...
                  <div className="section-content">
                    <p>
                      ...
                      emphasises that a situation is temporary. It often
                      describes a person&apos;s behaviour:
                    </p>
                    <p>
                      <span className={styles.example}>
                    ...
                    <p className={styles.example}>
                      My brother <strong>is being</strong> very nice to me this
                      week. I wonder what he wants!
                    </p>
                    <p className={styles.example}>
...
const Sidebar = ({ sideBarIsOpen, toggleSidebar, currentViewedTocItem }) => {
  return (
    <div className={styles["hamburger-menu"]}>
      ...
      <ul className={styles.menu__box}>
        ...
        <li>
          <a
            className={`${styles.menu__item} ${
              currentViewedTocItem === "present_continuous" ? styles.active : ""
            }`}
            href="#present_continuous"
          >
            Present continuous
