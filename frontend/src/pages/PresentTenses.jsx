      ...
      <ul>
        ...
        <li>
          ...
          <p className={styles.example}>
            ...
            {' '}
            <span>
              (= I don&apos;t usually work in London)
            </span>
          </p>
        </li>
        <li>
          <p>for an action around the time of speaking, which has begun but is not finished:</p>
          <p className={styles.example}>
            I
            <b>&apos;m cleaning</b>
            {' '}
          ...
          <p className={styles.example}>
            ...
            round the shops.
            <span>
              (Millie isn&apos;t looking round at this
              moment –
              she has stopped to talk to Lisa –
        ...
        <li>
          <p>with a word like always or continually if we want to criticise or complain:</p>
          <p className={styles.example}>
            You
            <b>&apos;re always buying</b>
            {' '}
            new clothes!
            {' '}
        ...
        <li>
          <p className={styles.example}>
            ...
            <em>always</em>
            {' '}
            when something unexpected happens several times:
          </p>
          <p>
            I
            <b>&apos;m always meeting</b>
            {' '}
            my neighbour John near the station. I guess he works somewhere near there.
          </p>
        </li>
      </ul>
    </div>
